...
/**
 * A Response is a Message which responses to a Request-Message.
 * The Response contains the Request and it can also contain an Exception or an Return-Object.
 */
public class Response extends Message {
    ...
    /** A reference to the responsible request. This element exists only for debug purposes. */
